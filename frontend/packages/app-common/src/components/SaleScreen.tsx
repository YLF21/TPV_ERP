  ...
  return (
    <main className={`sale-screen work-screen ${touchMode ? "touch-mode" : "keyboard-mode"}`}>
      ...
      {ticketManagementOpen && (
        <TicketManagementDialog token={session.accessToken} locale={locale} permissions={session.permissions} terminalContext={terminalContext} onClose={() => setTicketManagementOpen(false)} />
      )}
