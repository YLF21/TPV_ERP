...
function InformationFields({ fields }: { fields: InformationField[] }) {
  return (
...
export function StockProductInformationPanel({
  ...
  return (
    <section className="stock-product-information" aria-label={t("stock.detail.informationTitle")}>
      <div className="stock-product-information-identity">
        ...
        <div className="stock-product-information-identity-details">
          <h2>{valueOrDash(product.name)}</h2>
          <InformationFields fields={[
            ...
            { label: t("product.field.active"), value: translatedValue(product.active, t) }
          ]} />
        </div>
      </div>

      <div className="stock-product-information-summary">
        <InformationSection
        ...
        />
        <section className="stock-product-information-section stock-product-information-prices">
          <h3>{t("stock.detail.prices")}</h3>
          {canViewPurchaseFields && (
            <InformationSection
      ...
      <section className="stock-product-information-section stock-product-information-notes">
        <h3>{t("stock.detail.notes")}</h3>
        <InformationFields fields={[
          { label: t("product.field.description"), value: valueOrDash(product.description) },
          { label: t("product.field.comments"), value: valueOrDash(product.comments) }
        ]} />
      </section>

      <div className="stock-product-information-operations">
        <div className="stock-product-information-stock">
          {stockContent && (
            <section className="stock-product-information-section">
              <h3>{t("stock.detail.warehouseStock")}</h3>
              {stockContent}
            </section>
          )}
          <InformationSection
