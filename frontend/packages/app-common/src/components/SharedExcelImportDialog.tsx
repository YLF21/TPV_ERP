...
const productMappingFields: MappingField[] = [
  ...
  { key: "familyId", label: "Familia", aliases: ["familia", "family", "codigo familia", "código familia", "family code", "family id", "familyid"], updateKey: "familyId" },
  { key: "subfamilyId", label: "Subfamilia", aliases: ["subfamilia", "subfamily", "codigo subfamilia", "código subfamilia", "subfamily code", "subfamily id", "subfamilyid"], updateKey: "subfamilyId" },
  ...
  { key: "memberPrice", label: "Precio de miembro", aliases: ["precio de miembro", "precio miembro", "member price", "memberprice"], updateKey: "memberPrice" },
...
const sharedExcelFieldOrder: MappingField[] = [
  ...
  field("familyId", "Familia", "Family", "类别", ["familia", "family", "codigo familia", "código familia", "family code", "family id", "familyid"], "familyId"),
  field("subfamilyId", "Subfamilia", "Subfamily", "子类别", ["subfamilia", "subfamily", "codigo subfamilia", "código subfamilia", "subfamily code", "subfamily id", "subfamilyid"], "subfamilyId"),
