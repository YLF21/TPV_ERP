...
class PaymentTerminalV59MigrationContractTest {
    @Test
    void migrationAddsVersionedOpaqueProtectedSecretReferencesWithoutPlaintextColumns() throws Exception {
        var sql = Files.readString(Path.of("src/main/resources/db/migration/V59__payment_terminal_secret_references.sql"));
