...
class PosCardDocumentSnapshotTest {
 ...
 @Test void preservesAndRestoresDocumentAdjustmentLinks(){
  ...
  assertThat(DocumentService.snapshotManualDiscounts(restoredSnapshot).globalDiscountPercent())
          .isEqualByComparingTo("10.00");
  assertThat(DocumentService.snapshotManualDiscounts(restoredSnapshot).lines()).isEmpty();
