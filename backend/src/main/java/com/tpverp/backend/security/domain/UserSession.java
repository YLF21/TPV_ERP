...
public class UserSession {
    ...
    private UserAccount revocadaPor;
    ...
    public UserSession(UserAccount usuario, Terminal terminal, String tokenHash, Instant creadaEn) {
    ...
    public void revocar(UserAccount revocadaPor, String motivo, Instant cuando) {
        if (revocadaEn != null) {
