...
public class WarehouseOutputController {
    ...
    public PagedResult<WarehouseOutputView> list(
        ...
        return dateFrom == null && dateTo == null ? service.listPage(limit, cursor)
                : service.listPage(limit, cursor, dateFrom, dateTo);
    }

    public PagedResult<WarehouseOutputView> list(Integer limit, String cursor) {
