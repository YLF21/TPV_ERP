...
public class SalePaymentSessionService {
 ...
 private static String hash(PosCashController.SaleRequest sale,BigDecimal total){return hashText(sale.toString()+Money.euros(total));}
