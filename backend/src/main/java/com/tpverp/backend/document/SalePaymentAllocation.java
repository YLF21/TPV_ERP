...
public class SalePaymentAllocation {
 ...
 @Column(length=128) private String reference; @Column(name="authorization_code",length=64) private String authorization; @Column(length=512) private String message;
