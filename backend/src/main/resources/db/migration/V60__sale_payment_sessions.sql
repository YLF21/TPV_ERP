CREATE TABLE sale_payment_session (
 ...
 status varchar(32) NOT NULL, ticket_id uuid REFERENCES documento(id), ticket_number varchar(32), created_at timestamptz NOT NULL, updated_at timestamptz NOT NULL, version bigint NOT NULL DEFAULT 0,
...
CREATE TABLE sale_payment_allocation (
 ...
 status varchar(16) NOT NULL, reference varchar(128), authorization varchar(64), message varchar(512), created_at timestamptz NOT NULL, updated_at timestamptz NOT NULL, version bigint NOT NULL DEFAULT 0,
